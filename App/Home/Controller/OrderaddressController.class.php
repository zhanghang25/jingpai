<?php
    ...
    use Vendor\Page;
    class OrderaddressController extends ComController{
        ...
        public function lists(){
            ...
            $this->display ('Order/orderaddress');
        }
        public function edits(){
            ...
            $this->assign('idd',$data['id']);
            return $this->display ('Order/editaddress');
        }
        public function postedit(){
            ...
            if (array_diff_assoc($s,$data) ){
                return $this->ajaxReturn (array ('code'=>1,'msg'=>'修改成功','url'=>U ('Orderaddress/lists',array ('id'=>$idd))));
            }
            if ($u){
                return $this->ajaxReturn (array ('code'=>1,'msg'=>'修改成功','url'=>U ('orderaddlist/lists',array ('id'=>$idd))));
            }else{
        ...
        public function addpost(){
            ...
            $uu=$user->add($date);
            if ($uu){
                $this->ajaxReturn (array ('code'=>1,'msg'=>'添加收货地址成功','url'=>U('Orderaddress/lists',array ('id'=>$id))));
            }else{
